    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex flex-col items-center justify-center">
      ...
      <div className="relative animate-[fadeIn_0.3s_ease-in-out]">
        ...
        <div className="absolute -inset-20 opacity-20">
          <div className="absolute top-0 left-0 w-32 h-32 bg-blue-400 rounded-full blur-3xl animate-[float_6s_ease-in-out_infinite]" />
          <div className="absolute bottom-0 right-0 w-40 h-40 bg-purple-400 rounded-full blur-3xl animate-[float_8s_ease-in-out_infinite_1s]" />
        </div>
        ...
        <div className="relative bg-white rounded-2xl shadow-xl p-12 max-w-md w-full">
          ...
          <div className="flex justify-center mb-8">
            <div className="relative animate-[iconPulse_1.5s_ease-in-out_infinite]">
              {type === "video" ? (
              ...
              <div className="absolute -inset-2 border-4 border-transparent border-t-blue-500 border-r-purple-500 rounded-full animate-spin" />
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-lg text-gray-600 font-medium mb-2">
              ...
              <span className="inline-block animate-[dotAnimation1_1.6s_infinite]">.</span>
              <span className="inline-block animate-[dotAnimation2_1.6s_infinite]">.</span>
              <span className="inline-block animate-[dotAnimation3_1.6s_infinite]">.</span>
            </p>
          ...
          <div className="mt-6 bg-gray-200 rounded-full h-2 overflow-hidden">
            <div className="bg-gradient-to-r from-blue-500 to-purple-500 h-full rounded-full animate-[shimmer_2s_ease-in-out_infinite]" />
          </div>

          {/* Quick tips while loading */}
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            <p className="text-xs text-gray-600 text-center animate-[fadeIn_1s_ease-in-out_0.5s_both]">
              💡 Tip:{" "}
              {type === "video"
